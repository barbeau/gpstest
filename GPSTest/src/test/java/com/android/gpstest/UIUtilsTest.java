...
public class UIUtilsTest {
    ...
    /**
     * Left margin range for the C/N0 indicator ImageViews in gps_sky_signal_meter is from -5dp (10 dB-Hz) to 140dp (45 dB-Hz).
     */
    @Test
    public void testCn0ToLeftMargin() {
        float marginDp;

        // CN0 value of 27.5 dB-Hz is 50% between 10 and 45, so output should be halfway between -5dp and 140dp, which is 70dp
        marginDp = UIUtils.cn0ToIndicatorLeftMarginDp(27.5f);
        assertEquals(67.5f, marginDp);
